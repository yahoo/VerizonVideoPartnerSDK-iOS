 ...
 */
@interface OMIDVerizonmediaVideoEvents : NSObject
 ...
 * @see OMIDAdSession
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDVerizonmediaAdSession *)session error:(NSError *_Nullable *_Nullable)error;
 ...
 */
- (void)loadedWithVastProperties:(nonnull OMIDVerizonmediaVASTProperties *)vastProperties;
