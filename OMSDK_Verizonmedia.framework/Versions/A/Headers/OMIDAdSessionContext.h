 ...
 */
@interface OMIDVerizonmediaAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDVerizonmediaPartner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDVerizonmediaPartner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDVerizonmediaVerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
