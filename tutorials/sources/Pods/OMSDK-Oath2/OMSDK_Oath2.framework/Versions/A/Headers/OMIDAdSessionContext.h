 ...
 */
@interface OMIDOath2AdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(nonnull OMIDOath2Partner *)partner
...
- (nullable instancetype)initWithPartner:(nonnull OMIDOath2Partner *)partner
                               ...
                               resources:(nonnull NSArray<OMIDOath2VerificationScriptResource *> *)resources
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
