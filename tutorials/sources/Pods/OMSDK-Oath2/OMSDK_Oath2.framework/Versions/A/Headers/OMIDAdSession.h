 ...
 */
@interface OMIDOath2AdSession : NSObject

/*!
 * @abstract The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly, nonnull) OMIDOath2AdSessionConfiguration *configuration;
/*!
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDOath2AdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDOath2AdSessionContext *)context
