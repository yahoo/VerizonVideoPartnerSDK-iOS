 ...
 */
@property(nonatomic, readonly, nonnull) OMIDVerizonmediaAdSessionConfiguration *configuration;
/*!
 ...
 */
- (nullable instancetype)initWithConfiguration:(nonnull OMIDVerizonmediaAdSessionConfiguration *)configuration
                              adSessionContext:(nonnull OMIDVerizonmediaAdSessionContext *)context
