 ...
 */
@property(nonatomic, readonly) OMIDVerizonmediaAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDVerizonmediaAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDVerizonmediaAdSessionContext *)context
